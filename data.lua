...
local function GetFilterCallback(filterTypes, checkOnlyJunk)
    return function(slot, slotIndex)
        checkOnlyJunk = checkOnlyJunk or false
        slot = checkCraftingStationSlot(slot, slotIndex)
...
AF.subfilterCallbacks = {
    All = {
        ...
        dropdownCallbacks = {
            {name = AF_CONST_ALL,
             filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallback(nil), nil) end,
    ...
    WeaponsSmithing = {
        ...
        OneHand = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_AXE, WEAPONTYPE_HAMMER, WEAPONTYPE_SWORD, WEAPONTYPE_DAGGER}), {WEAPONTYPE_AXE, WEAPONTYPE_HAMMER, WEAPONTYPE_SWORD, WEAPONTYPE_DAGGER}) end,
            ...
            dropdownCallbacks = {
                {name = "Axe", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_AXE}), WEAPONTYPE_AXE)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_AXE})},
                {name = "Hammer", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_HAMMER}), WEAPONTYPE_HAMMER)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_HAMMER})},
                {name = "Sword", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_SWORD}), WEAPONTYPE_SWORD)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_SWORD})},
                {name = "Dagger", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_DAGGER}), WEAPONTYPE_DAGGER)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_DAGGER})},
            },
        },
        TwoHand = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_AXE, WEAPONTYPE_TWO_HANDED_HAMMER, WEAPONTYPE_TWO_HANDED_SWORD}), {WEAPONTYPE_TWO_HANDED_AXE, WEAPONTYPE_TWO_HANDED_HAMMER, WEAPONTYPE_TWO_HANDED_SWORD}) end,
            filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_AXE, WEAPONTYPE_TWO_HANDED_HAMMER, WEAPONTYPE_TWO_HANDED_SWORD}),
            dropdownCallbacks = {
                {name = "TwoHandAxe", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_AXE}), WEAPONTYPE_TWO_HANDED_AXE)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_AXE})},
                {name = "TwoHandHammer", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_HAMMER}), WEAPONTYPE_TWO_HANDED_HAMMER)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_HAMMER})},
                {name = "TwoHandSword", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_SWORD}), WEAPONTYPE_TWO_HANDED_SWORD)end, filterCallback=GetFilterCallbackForWeaponType({WEAPONTYPE_TWO_HANDED_SWORD})},
            },
        },
    },
    WeaponsWoodworking = {
        ...
        Bow = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_BOW}), WEAPONTYPE_BOW)end,
            filterCallback = function() return GetFilterCallbackForWeaponType({WEAPONTYPE_BOW}) end,
            dropdownCallbacks = {
                {name = "Bow", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_BOW}), WEAPONTYPE_BOW)end,filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_BOW})},
            },
        },
        DestructionStaff = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_FIRE_STAFF, WEAPONTYPE_FROST_STAFF, WEAPONTYPE_LIGHTNING_STAFF}), {WEAPONTYPE_FIRE_STAFF, WEAPONTYPE_FROST_STAFF, WEAPONTYPE_LIGHTNING_STAFF})end,
            filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_FIRE_STAFF, WEAPONTYPE_FROST_STAFF, WEAPONTYPE_LIGHTNING_STAFF}),
            dropdownCallbacks = {
                {name = "Fire", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_FIRE_STAFF}), WEAPONTYPE_FIRE_STAFF)end,filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_FIRE_STAFF})},
                {name = "Frost", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_FROST_STAFF}), WEAPONTYPE_FROST_STAFF)end,filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_FROST_STAFF})},
                {name = "Lightning", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_LIGHTNING_STAFF}), WEAPONTYPE_LIGHTNING_STAFF)end,filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_LIGHTNING_STAFF})},
            },
        },
        HealStaff = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_HEALING_STAFF}), WEAPONTYPE_HEALING_STAFF)end,
            filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_HEALING_STAFF}),
            dropdownCallbacks = {
                {name = "HealStaff", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForWeaponType({WEAPONTYPE_HEALING_STAFF}), WEAPONTYPE_HEALING_STAFF)end,filterCallback = GetFilterCallbackForWeaponType({WEAPONTYPE_HEALING_STAFF})},
            },
        },
    },
    Armor = {
    ...
    ArmorSmithing = {
        ...
        Heavy = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForArmorType({ARMORTYPE_HEAVY}), nil, ARMORTYPE_HEAVY)end,
            filterCallback = GetFilterCallbackForArmorType({ARMORTYPE_HEAVY}),
            dropdownCallbacks = {
                {name = "Head", showIcon=true,      filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_HEAD), EQUIP_TYPE_HEAD, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_HEAD})},
                {name = "Chest", showIcon=true,     filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_CHEST), EQUIP_TYPE_CHEST, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_CHEST})},
                {name = "Shoulders", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_SHOULDERS), EQUIP_TYPE_SHOULDERS, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_SHOULDERS})},
                {name = "Hand", showIcon=true,      filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_HAND), EQUIP_TYPE_HAND, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_HAND})},
                {name = "Waist", showIcon=true,     filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_WAIST), EQUIP_TYPE_WAIST, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_WAIST})},
                {name = "Legs", showIcon=true,      filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_LEGS), EQUIP_TYPE_LEGS, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_LEGS})},
                {name = "Feet", showIcon=true,      filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_FEET), EQUIP_TYPE_FEET, ARMORTYPE_HEAVY)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_FEET})},
            },
        },
    },
    ArmorClothier = {
        ...
        LightArmor = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForArmorType({ARMORTYPE_LIGHT}), nil, ARMORTYPE_LIGHT)end,
            filterCallback = GetFilterCallbackForArmorType({ARMORTYPE_LIGHT}),
            dropdownCallbacks = {
                {name = "Head", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_HEAD, {ARMORTYPE_LIGHT}), EQUIP_TYPE_HEAD, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_HEAD}, {ARMORTYPE_LIGHT})},
                {name = "Chest", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_CHEST, {ARMORTYPE_LIGHT}), EQUIP_TYPE_CHEST, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_CHEST}, {ARMORTYPE_LIGHT})},
                {name = "Shoulders", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_SHOULDERS, {ARMORTYPE_LIGHT}), EQUIP_TYPE_SHOULDERS, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_SHOULDERS}, {ARMORTYPE_LIGHT})},
                {name = "Hand", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_HAND, {ARMORTYPE_LIGHT}), EQUIP_TYPE_HAND, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_HAND}, {ARMORTYPE_LIGHT})},
                {name = "Waist", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_WAIST, {ARMORTYPE_LIGHT}), EQUIP_TYPE_WAIST, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_WAIST}, {ARMORTYPE_LIGHT})},
                {name = "Legs", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_LEGS, {ARMORTYPE_LIGHT}), EQUIP_TYPE_LEGS, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_LEGS}, {ARMORTYPE_LIGHT})},
                {name = "Feet", showIcon=true, addString="Light", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_FEET, {ARMORTYPE_LIGHT}), EQUIP_TYPE_FEET, ARMORTYPE_LIGHT)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_FEET}, {ARMORTYPE_LIGHT})},
            },
        },
        Medium = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForArmorType({ARMORTYPE_MEDIUM}), nil, ARMORTYPE_MEDIUM)end,
            filterCallback = GetFilterCallbackForArmorType({ARMORTYPE_MEDIUM}),
            dropdownCallbacks = {
                {name = "Head", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_HEAD, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_HEAD, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_HEAD}, {ARMORTYPE_MEDIUM})},
                {name = "Chest", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_CHEST, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_CHEST, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_CHEST}, {ARMORTYPE_MEDIUM})},
                {name = "Shoulders", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_SHOULDERS, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_SHOULDERS, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_SHOULDERS}, {ARMORTYPE_MEDIUM})},
                {name = "Hand", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_HAND, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_HAND, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_HAND}, {ARMORTYPE_MEDIUM})},
                {name = "Waist", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_WAIST, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_WAIST, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_WAIST}, {ARMORTYPE_MEDIUM})},
                {name = "Legs", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_LEGS, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_LEGS, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_LEGS}, {ARMORTYPE_MEDIUM})},
                {name = "Feet", showIcon=true, addString="Medium", filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear(EQUIP_TYPE_FEET, {ARMORTYPE_MEDIUM}), EQUIP_TYPE_FEET, ARMORTYPE_MEDIUM)end,filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_FEET}, {ARMORTYPE_MEDIUM})},
            },
        },
    },
    ArmorWoodworking = {
        ...
        Shield = {
            filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear({EQUIP_TYPE_OFF_HAND}), EQUIP_TYPE_OFF_HAND)end,
            filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_OFF_HAND}),
            dropdownCallbacks = {
                {name = "Shield", showIcon=true, filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForGear({EQUIP_TYPE_OFF_HAND}), EQUIP_TYPE_OFF_HAND)end, filterCallback = GetFilterCallbackForGear({EQUIP_TYPE_OFF_HAND})},
            },
        },
    },
    Jewelry = {
        ...
        Neck = {
            ...
            dropdownCallbacks = {
                ...
                {name = "Bloodthirsty", showIcon=true, addString = "Neck",  filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_BLOODTHIRSTY), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_BLOODTHIRSTY)},
                {name = "Harmony", showIcon=true, addString = "Neck",       filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_HARMONY), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_HARMONY)},
                {name = "Healthy", showIcon=true, addString = "Neck",       filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_HEALTHY), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_HEALTHY)},
                {name = "Infused", showIcon=true, addString = "Neck",       filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_INFUSED), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_INFUSED)},
                {name = "Intricate", showIcon=true, addString = "Neck",     filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_INTRICATE), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_INTRICATE)},
                {name = "Ornate", showIcon=true, addString = "Neck",        filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_ORNATE), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_ORNATE)},
                {name = "Protective", showIcon=true, addString = "Neck",    filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_PROTECTIVE), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_PROTECTIVE)},
                {name = "Robust", showIcon=true, addString = "Neck",        filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_ROBUST), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_ROBUST)},
                {name = "Swift", showIcon=true, addString = "Neck",         filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_SWIFT), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_SWIFT)},
                {name = "Triune", showIcon=true, addString = "Neck",        filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_TRIUNE), EQUIP_TYPE_NECK, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_NECK}, ITEM_TRAIT_TYPE_JEWELRY_TRIUNE)},
            },
        },
        Ring = {
            ...
            dropdownCallbacks = {
                ...
                {name = "Bloodthirsty", showIcon=true, addString = "Ring",  filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_BLOODTHIRSTY), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_BLOODTHIRSTY)},
                {name = "Harmony", showIcon=true, addString = "Ring",       filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_HARMONY), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_HARMONY)},
                {name = "Healthy", showIcon=true, addString = "Ring",       filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_HEALTHY), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_HEALTHY)},
                {name = "Infused", showIcon=true, addString = "Ring",       filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_INFUSED), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_INFUSED)},
                {name = "Intricate", showIcon=true, addString = "Ring",     filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_INTRICATE), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_INTRICATE)},
                {name = "Ornate", showIcon=true, addString = "Ring",        filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_ORNATE), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_ORNATE)},
                {name = "Protective", showIcon=true, addString = "Ring",    filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_PROTECTIVE), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_PROTECTIVE)},
                {name = "Robust", showIcon=true, addString = "Ring",        filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_ROBUST), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_ROBUST)},
                {name = "Swift", showIcon=true, addString = "Ring",         filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_SWIFT), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_SWIFT)},
                {name = "Triune", showIcon=true, addString = "Ring",        filterStartCallback = function() util.CheckForResearchPanelAndRunFilterFunction(GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_TRIUNE), EQUIP_TYPE_RING, nil)end, filterCallback = GetFilterCallbackForJewelry({EQUIP_TYPE_RING}, ITEM_TRAIT_TYPE_JEWELRY_TRIUNE)},
            },
        },
    },
    Consumables = {
    ...
    Junk = {
        ...
        Consumable = {
            filterCallback = GetFilterCallback({ITEMTYPE_CROWN_ITEM, ITEMTYPE_FOOD, ITEMTYPE_DRINK, ITEMTYPE_RECIPE, ITEMTYPE_POTION, ITEMTYPE_POISON, ITEMTYPE_RACIAL_STYLE_MOTIF, ITEMTYPE_CONTAINER, ITEMTYPE_CONTAINER_CURRENCY, ITEMTYPE_AVA_REPAIR, ITEMTYPE_TOOL, ITEMTYPE_CROWN_REPAIR, ITEMTYPE_TROPHY, ITEMTYPE_COLLECTIBLE, ITEMTYPE_FISH, ITEMTYPE_TREASURE}, true),
            dropdownCallbacks = {
        ...
        Miscellaneous = {
            filterCallback = GetFilterCallback({ITEMTYPE_GLYPH_ARMOR, ITEMTYPE_GLYPH_JEWELRY, ITEMTYPE_GLYPH_WEAPON, ITEMTYPE_SOUL_GEM, ITEMTYPE_SIEGE, ITEMTYPE_LURE, ITEMTYPE_TOOL, ITEMTYPE_TROPHY, ITEMTYPE_COLLECTIBLE, ITEMTYPE_FISH, ITEMTYPE_TREASURE, ITEMTYPE_TRASH, ITEMTYPE_DISGUISE, ITEMTYPE_TABARD}, true),
            dropdownCallbacks = {
                ...
                {name = "Tool", showIcon=true, filterCallback = GetFilterCallback({ITEMTYPE_TOOL}, true)},
                {name = "Trophy", showIcon=true, filterCallback = GetFilterCallbackForTrophy(true)},
